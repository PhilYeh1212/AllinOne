...
with open(r'C:\FS103.csv', newline='') as csvfile:
    ...
    if inTI - fivemin >= 300:
        for sitecode in row:
            try:
                ...
                #                (sitecode[0]+'01', sitecode[0] + 'M0', inverternum, '0', INVdata[j][15], INVdata[j][14], '####' + str(INVdata[j][5]), str(INVdata[j][6]), str(float(INVdata[j][2]) / 1000), str(INVdata[j][7]), (str(INVdata[j][8])+'###\n'))
                ...
                #         inverternum = j + 1
                #         raw0 = '%s#%s%s%s#%s %s#%s#%s#%s#%s#%s' % \
                #                (sitecode[0]+'01', sitecode[0] + 'M2', inverternum, '0', INVdata[j][15], INVdata[j][14], '####' + str(INVdata[j][5]), str(INVdata[j][6]), str(float(INVdata[j][2]) / 1000), str(INVdata[j][7]), (str(INVdata[j][8])+'###\n'))
                #         RAWline = RAWline + raw0
                #         raw1 = '%s#%s%s%s#%s %s#%s#%s#%s' % \
                ...
                #         inverternum = j + 1
                #         raw0 = '%s#%s%s%s#%s %s#%s#%s#%s#%s#%s' % \
                #                (sitecode[0]+'01', sitecode[0] + 'M4', inverternum, '0', INVdata[j][15], INVdata[j][14], '####' + str(INVdata[j][5]), str(INVdata[j][6]), str(float(INVdata[j][2]) / 1000), str(INVdata[j][7]), (str(INVdata[j][8])+'###\n'))
                #         RAWline = RAWline + raw0
                #         raw1 = '%s#%s%s%s#%s %s#%s#%s#%s' % \
                ...
                #         inverternum = j + 1
                #         raw0 = '%s#%s%s%s#%s %s#%s#%s#%s#%s#%s' % \
                #                (sitecode[0]+'01', sitecode[0] + 'M3', inverternum, '0', INVdata[j][15], INVdata[j][14], '####' + str(INVdata[j][5]), str(INVdata[j][6]), str(float(INVdata[j][2]) / 1000), str(INVdata[j][7]), (str(INVdata[j][8])+'###\n'))
                #         RAWline = RAWline + raw0
                #         raw1 = '%s#%s%s%s#%s %s#%s#%s#%s' % \
                ...
                #                    '####' + str(INVdata[j][5]), str(INVdata[j][6]), str(float(INVdata[j][2] / 1000)),
