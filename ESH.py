...
delete_sql = "DELETE FROM all_das2_ESH_Correct ORDER BY date DESC LIMIT 59"
mycursor.execute(delete_sql)

# 提取das_XX_download_bk表中最新的60條記錄
mycursor.execute("SELECT * FROM Fs_all_das2_ESH_Correct ORDER BY date DESC LIMIT 60")
